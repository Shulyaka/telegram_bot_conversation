"""Sensor platform for telegram_bot_conversation."""
...
ENTITY_DESCRIPTIONS = (
    SensorEntityDescription(
        ...
        name="Telegram Bot Conversation Sensor",
...
class TelegramBotConversationSensor(TelegramBotConversationEntity, SensorEntity):
    """telegram_bot_conversation Sensor class."""
