"""Switch platform for telegram_bot_conversation."""
...
ENTITY_DESCRIPTIONS = (
    SwitchEntityDescription(
        ...
        name="Telegram Bot Conversation Switch",
...
class TelegramBotConversationSwitch(TelegramBotConversationEntity, SwitchEntity):
    """telegram_bot_conversation switch class."""
